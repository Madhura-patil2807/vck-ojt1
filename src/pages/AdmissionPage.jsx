...
const Admission = () => {
    return (
        ...
        <div>
            ...
            <h2 className="admission">Eligibility Criteria for Undergraduate Programs</h2>
            ...
            <tbody>
                ...
                <h2 className="admission">Application Process</h2>
                <ol className="orderlist">
                    <li>
                        <b>Online Application: </b>"Fill out the application form available on our portal."</li>

                    <li>
                        <b>Document Submission:</b>"Upload scanned copies of required documents (mark sheets, ID proof, etc.)."
                    </li>
                    <li>
                        <b>Entrance Exam (if applicable):</b>"Appear for the college's entrance examination."
                    </li>
                    <li>
                        <b>Merit List & Interview:</b>"Check the merit list and attend the interview if shortlisted."
                    </li>
                    <li>
                ...
                <p className="p">
                    For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our
                        ...
                        <a href="/Courses" data-discover="true">CoursesPage</a>

                        or

                        <a href="/Contact" data-discover="true">contactus</a>
